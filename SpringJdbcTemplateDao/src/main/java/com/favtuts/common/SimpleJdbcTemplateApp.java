...
public class SimpleJdbcTemplateApp 
{
    public static void main( String[] args )
    {
        ...
        Customer customer1 = new Customer(1, "favtuts1",21);
        Customer customer3 = new Customer(2, "favtuts2",22);
        Customer customer2 = new Customer(3, "favtuts3",23);
        ...
        Customer customer4 = new Customer(4, "favtuts4",24);
        Customer customer5 = new Customer(5, "favtuts5",25);
        Customer customer6 = new Customer(6, "favtuts6",26);
